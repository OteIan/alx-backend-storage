...
solution - [0-list_databases](./0-list_databases)
...
solution - [10-update_topics.py](./10-update_topics.py)
...
solution - [11-schools_by_topic.py](./11-schools_by_topic.py)
...
solution - [102-log_stats.py](./102-log_stats.py)